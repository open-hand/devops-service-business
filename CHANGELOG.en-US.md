...
All notable changes to devops-service-business-business will be documented in this file.
...
- Fixed the issue that the gitops file could not be found in the interface deployment in the case of devops-service-business-business service multiple instances
...
- Fixed an issue where the agent was disconnected from devops-service-business-business but the cluster still showed normal 
...
- Inconsistent status after devops-service-business-business and env-agent restart.
